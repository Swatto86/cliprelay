...
4. **Select File**: File dialog opens - choose any file up to **50 MiB**
...
✅ Files larger than clipboard limit (up to 50 MiB)  
...
- Files over 50 MiB rejected with clear error message  
...
# On PC1: Double-click tray → "Send File..." → Choose file ≤50 MiB
...
- [ ] Configurable file size limit (currently hardcoded 50 MiB)
